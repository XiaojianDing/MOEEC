function Q=Convert_To_Pair_Q_Test(errorMatrix,ytest)
% This code used to compute Double Fault Diversity betwee)
% This code used to compute Q test between more than two classifiers
...
for i=1:size(errorMatrix,2)
   for j=i:size(errorMatrix,2)
    ...
    S=S+Q_Test(errorMatrix(:,i),errorMatrix(:,j));      
    Counter=Counter+1;
   end
end

Q=S/size(errorMatrix,2);